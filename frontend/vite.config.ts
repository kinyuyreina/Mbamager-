  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Mbamager',
        short_name: 'Mbamager',
        description: 'Your AI-powered financial operating system for Cameroon.',
        lang: 'en',
        start_url: '/dashboard',
        display: 'standalone',
      ...
      workbox: {
        // Never cache API calls - the app must always hit the live backend
        // for account/transaction data, never a stale cached response.
